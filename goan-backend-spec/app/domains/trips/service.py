...
async def create_trip(db: AsyncSession, rider: User, payload: TripCreate) -> tuple[Trip, FareBreakdown]:
...
def distance_driver_to_pickup(
    driver_lat: float, driver_lng: float, trip: Trip
) -> Decimal:
