...
from sqlalchemy import DateTime, Enum, Float, ForeignKey, Index, JSON, String, Uuid, func
...
class FraudIncident(Base):
    ...
    fraud_type: Mapped[FraudType] = mapped_column(Enum(FraudType, name="fraud_type"), nullable=False)
